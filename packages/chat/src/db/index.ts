...
import { ChatMigrationProvider } from './migrations/provider'
...
export class Database {
  ...
  constructor(
    ...
    // Setup schema usage, primarily for test parallelism
    ...
    this.migrator = new Migrator({
      ...
      provider: new ChatMigrationProvider(migrations),
    })
  }

  static create(opts: PgOptions): Database {
